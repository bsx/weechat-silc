...
int silc_config_reload(const void *pointer, void *data, struct t_config_file *config_file) {
    // reload called
    return WEECHAT_RC_OK;
}

int silc_plugin_config_init() {
    config_file = weechat_config_new(SILC_CONFIG_NAME, &silc_config_reload, NULL, NULL);
